...
class Data():
    ...
    def return_stats(self, puuid, limit = 20):
        ...
        # Removing the three columns for ease of graphing later with no redundant variables, without creating a new variable
    ...
    def return_timeline_stats(self, match_id):
        ...
        # Add .melt() to the dataframe to reshape the data from wide format to long format data for graphing
        df_long = df.melt(
            id_vars = "minute",
...
class Data_Flask():
    ...
    def return_timeline_stats(self, rows):
        ...
        # Mapping colors to teams respectively for graphing
        df_long["team"] = df_long["team"].map({
            "player_team": "blue",
            "enemy_team": "red"}
        )
